...
Look Up Result prefers the immutable `oracle-history.json` entry over a live recompute, tagged 📌 recorded vs ↻ recomputed. The seeded panel has no such tag: it is always a live cast, and its seed is named on the card instead.
